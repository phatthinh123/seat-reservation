package com.tpthinh.seatreservation.adapter.payment;
...
public class MockPaymentGatewayAdapter implements PaymentGatewayPort {
    ...
    @Override
    public String initiatePayment(UUID bookingId, BigDecimal amount, String customCallbackUrl, boolean simulateFail, boolean simulateDelay) {
