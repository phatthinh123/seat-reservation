...
public class PaymentController {
    ...
    public ResponseEntity<PaymentResponse> initiatePayment(
        ...
        boolean simulateDelay = body != null && body.simulateDelay();
        InitiatePaymentUseCase.InitiatePaymentCommand cmd =
            new InitiatePaymentUseCase.InitiatePaymentCommand(bookingId, userId, simulateFail, simulateDelay);
    ...
    record InitiatePaymentRequest(boolean simulateFail, boolean simulateDelay) {}
}
