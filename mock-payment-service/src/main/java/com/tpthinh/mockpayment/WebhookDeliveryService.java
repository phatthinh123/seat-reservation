...
public class WebhookDeliveryService {
    ...
    public void scheduleDelivery(String paymentId, String bookingId, String callbackUrl, boolean simulateFail, boolean simulateDelay) {
        log.info("Scheduling webhook delivery for payment {} (booking {}), simulateFail={}, simulateDelay={}", paymentId, bookingId, simulateFail, simulateDelay);
        try {
            // Check both passed parameter and global flag
            boolean actualDelay = simulateDelay || SimulationController.nextDelay.getAndSet(false);
            if (actualDelay) {
